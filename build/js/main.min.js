...
var navigationMinus = document.querySelector('.navigation__minus');
var addressMinus = document.querySelector('.address__minus');
var navigationList = document.querySelector('.navigation__list');
var addressList = document.querySelector('.address__list');
var mobileText = document.querySelector('.about__content--mobile');
if (breakpoint.matches) {
  ...
  var addressButton = document.querySelector('.address__title');
  ...
  var navigationButton = document.querySelector('.navigation__title');
...
var additionAboutText = document.querySelector('.about__content--addition');
...
var modalOverlay = document.querySelector('.modal__content');
var body = document.querySelector('body');
var closeModalButton = document.querySelector('.modal__close-btn');
...
modal.addEventListener('click', function (e) {
  var click = e.composedPath().includes(modalOverlay);
  if (!click) {
    modal.classList.remove('is-active');
    body.style.overflow = 'visible';
  }
...
var element = document.querySelector('.form__input--telephone');
var elementTwo = document.querySelector('.modal__input--telephone');
var maskOptions = {
  mask: '+{7}(000)000-00-00'
};
var mask = new imask__WEBPACK_IMPORTED_MODULE_3__["default"](element, maskOptions);
var maskTwo = new imask__WEBPACK_IMPORTED_MODULE_3__["default"](elementTwo, maskOptions);
// ---------------------------------
